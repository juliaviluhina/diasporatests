...
public class Users {
    ...
    public static final PodUser SAM = new PodUser("sam_tjvi", "tjvitjvi", "https://nerdpol.ch", "sam.tjvi@gmail.com");

    //account which is not prepared for using
    public static final PodUser DAVE = new PodUser("dave_tjvi", "tjvitjvi", "https://diasporabrazil.org", "dave.tjvi@gmail.com");
